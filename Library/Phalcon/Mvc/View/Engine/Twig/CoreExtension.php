...
class CoreExtension extends \Twig_Extension
{
    ...
    public function getFunctions()
    {
        ...
        return [
            'assetsOutputCss' => new \Twig_SimpleFunction('assetsOutputCss', [$this, 'functionAssetsOutputCss'], $options),
            'assetsOutputJs' => new \Twig_SimpleFunction('assetsOutputJs', [$this, 'functionAssetsOutputJs'], $options)
        ];
    }
